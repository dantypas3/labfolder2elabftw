...
class Transformer:
    ...
    def _filter_entries_by_first_names(self, first_names: List[str]) -> pd.DataFrame:
        """
        Return only rows whose author's first_name matches any of the given names (case-insensitive).
        """
